...
export default function Onboard() {
  return (
    <Container>
      ...
      <br />
      <Row>
        The bar graph on the lower left breaks down your climbs grouped by grades, type and outcome. Outcomes are grouped by "Send" outcomes (Redpoint, Flash, Onsight, Pinkpoint), "TR" outcomes (Tronsight, No Falls, TR attempt), "Repeat" and "Attempt". Boulder flashes are categorized seperately, and of course the TR category doesn't apply. It's entirely up to you how to categorize the outcome of your climb, but your data will be displayed differently depending on what outcome you choose. 
      </Row>
      <br />
      <Row>
        Clicking on a climb in the log entry sidebar or in the graph will show you details about that climb, including all the entries you've made for that climb. Here you can see your total number of ascents and attempts for that climb, and see all your notes and beta consolidated in one place. 
      </Row>
      <br />
      <Row>
